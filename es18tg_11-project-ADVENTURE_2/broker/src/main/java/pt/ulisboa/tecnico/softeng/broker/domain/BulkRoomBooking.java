...
public class BulkRoomBooking {
	...
	public BulkRoomBooking(String IBAN, String NIF, int number, LocalDate arrival, LocalDate departure) {
		this.number = number;
	...
	public void processBooking() {
		...
		try {
			this.references.addAll(HotelInterface.bulkBooking(this.IBAN, this.NIF, this.number, this.arrival, this.departure));
