...
public class BrokerPersistenceTest extends BaseTest {
	@Test
	public void success() {
		atomicProcess(); //Coloca toda a informacao na base de dados e persiste-a
		atomicAssert(); //Trata dos asserts e da leitura da base de dados
	}
	...
	public void atomicAssert() {
		...
		// Feito na aula - E so uma base
		List<Client> clients = new ArrayList<>(broker.getClientSet());
		Client cli = clients.get(0);
		assertEquals(CLIENT_IBAN, cli.getIBAN());
		// Feito na aula - E so uma base
