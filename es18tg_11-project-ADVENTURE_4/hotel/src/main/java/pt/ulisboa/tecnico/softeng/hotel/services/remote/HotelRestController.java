...
public class HotelRestController {
	...
	public ResponseEntity<String> reserve(@RequestParam Room.Type type,
		...
		try {
			return new ResponseEntity<>(HotelInterface.reserveRoom(type, arrival, departure, buyerNif, buyerIban),
					HttpStatus.OK);
	...
	public ResponseEntity<String[]> bulk(@RequestParam int number,
			...
			@DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam LocalDate departure,
			@RequestParam String buyerNif, @RequestParam String buyerIban) {
		logger.info("bulk number:{}, arrival:{}, departure:{}, buyerNif:{}, buyerIban:{}", number, arrival, departure, 
				buyerNif, buyerIban);
		try {
