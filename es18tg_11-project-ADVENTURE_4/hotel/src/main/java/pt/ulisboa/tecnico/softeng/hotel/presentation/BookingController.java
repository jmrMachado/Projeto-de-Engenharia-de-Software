...
public class BookingController {
	...
	public String bookingSubmit(Model model, @PathVariable String code, @PathVariable String number,
            @ModelAttribute(value ="booking") RoomBookingData booking) {
		logger.info("bookingSubmit hotelCode:{}, roomNumber:{}, arrival:{}, departure:{},"
				+ "buyerNIF:{},buyerIBAN{}", code, number,
				booking.getArrival(), booking.getDeparture(),
				booking.getBuyerNif(),booking.getBuyerIban());
