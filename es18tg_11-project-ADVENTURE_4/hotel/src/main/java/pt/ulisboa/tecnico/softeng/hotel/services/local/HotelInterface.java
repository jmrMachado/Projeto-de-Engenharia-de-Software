...
public class HotelInterface {
	...
	public static void createHotel(HotelData hotelData) {
		if (hotelData.getCode() == null || hotelData.getName().equals("") || 
						hotelData.getName() == null || hotelData.getPriceDouble() == null || hotelData.getPriceSingle() == null
						|| hotelData.getPriceDouble()<=0 || hotelData.getPriceSingle()<=0 || hotelData.getIban() == null
						|| hotelData.getNif() == null)
