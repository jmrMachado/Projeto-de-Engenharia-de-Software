...
public class Adventure extends Adventure_Base {
	...
	public Adventure(LocalDate begin, LocalDate end, Client client,double amount, double margin) {
		this(begin, end, client, amount, margin, false);
	}

	public Adventure(LocalDate begin, LocalDate end, Client client, double amount, double margin, boolean rentVehicle) {
		checkArguments(begin, end, client, amount, margin);

		setID(Integer.toString(client.getCounter()));
		setBegin(begin);
		setEnd(end);
		setMargin(margin);
	...
	private void checkArguments(LocalDate begin, LocalDate end, Client client, double amount, double margin) {
