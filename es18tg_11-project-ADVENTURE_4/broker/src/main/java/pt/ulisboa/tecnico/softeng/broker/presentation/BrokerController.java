...
public class BrokerController {
	...
	/*@RequestMapping(value = "/broker/{code}", method = RequestMethod.GET)
	public String showBroker(Model model, @PathVariable String code) {
		logger.info("showBroker code:{}", code);

		Broker broker = Broker.getBrokerByCode(code);
